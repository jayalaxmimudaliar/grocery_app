...
public class SimilarAdapter extends RecyclerView.Adapter<SimilarAdapter.viewholder> {
    ...
    public viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext(); // Initialize context properly here
        View itemView = LayoutInflater.from(context).inflate(R.layout.viewholder_similar, parent, false);
    ...
    public void onBindViewHolder(@NonNull viewholder holder, int position) {
        int drawableResourceId = context.getResources()
                .getIdentifier(items.get(position).getImgPath(), "drawable", context.getPackageName());
